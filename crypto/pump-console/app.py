...
import difflib # For debugging remove later

# --- Challenge Configuration ---
MASTER_KEY = b'R3c0gn1z3r_P4trol_K3y_v1.0'
...
def execute():
    ...
    print(f"Expected MAC: {expected_mac}", 'info')
    ...
    # Only decode for execution after MAC verification
